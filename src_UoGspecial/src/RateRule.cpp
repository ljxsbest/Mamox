...
{
	addRate(ID, param, A, n, E, "");
//Rate newRate(ID, param, A, n, E);
//rates.push_back(newRate);
}

void RateRule::addRate(std::string ID, std::vector<std::string> param, double A, double n, double E, std::string ref)
{
	Rate newRate(ID, param, A, n, E, ref);
	rates.push_back(newRate);
}
