...
public:
	...
	double A_ether_from_POOH2[3][3][4][3];		// ethers from POOH2
	double n_ether_from_POOH2[3][3][4][3];
	double E_ether_from_POOH2[3][3][4][3];
...
public:
	...
	std::string v_initiation(Radicale r1, Radicale r2, int isomers);
	std::string v_h_abstraction(HAbsRad r, Carbonio c, int numH, int isomers, std::string corr);
	std::string v_isomerization_r(Radicale r, Idrogeno h, Anello a, int numH);
	std::string v_beta_dec_r(Radicale r1, Radicale r2);
	std::string v_ole_par_r(int numH);
	std::string v_o2_add_r(Radicale r);
	std::string v_o2_rem_roo(Radicale r, int numC);
	std::string v_isom_roo(Radicale r, Idrogeno h, Anello a, int numH);
	std::string v_isom_ooqooh(Radicale r, Idrogeno h, Anello a, int numH);
	std::string v_isom_qooh(Radicale r1, Radicale r2, Anello a, int numC);
	std::string v_isom_pooh2(Radicale r1, Radicale r2, Anello a);
	std::string v_o2_add_qooh(Radicale r);
	std::string v_o2_rem_ooqooh(Radicale r, int numC);
	std::string v_ooqooh_to_khp(Radicale r1, Radicale r2, Anello a, int numH);
	std::string v_khp_decomp(Radicale r, int dist);
	std::string v_ole_par_roo(Radicale r1, Carbonio c, int numH);
	std::string v_ole_par_ooqooh(Radicale r1, Carbonio c, int numH);
	std::string v_ole_from_beta_qooh(Radicale r1, Radicale r2);
	std::string v_ole_from_gamma_qooh(Radicale r1, Radicale r2);
	std::string v_ole_from_delta_qooh(Radicale r1, Radicale r2);
	std::string v_pooh2_dec_1(Radicale r1, Radicale r2);
	std::string v_pooh2_dec_2(Radicale r1, Radicale r2);
	std::string v_pooh2_dec_3(Radicale r1, Radicale r2);
	std::string v_ether_from_qooh(Radicale r1, Radicale r2, AnelloO a, Carbonio corr);
	std::string v_ether_from_pooh2(Radicale r1, Radicale r2, AnelloO a, Carbonio corr);
	...
	std::string v_oleooh_dec(Radicale r);
	std::string v_etherooh_dec(Radicale r);
	std::string v_cyc_eth_dec();
	std::string v_allylic_rad_form(Carbonio c, int numH);
	std::string v_alkenyl_ro_form();
	std::string v_alkenyl_ro_dec(Carbonio c);
	std::string v_ald_dec();
