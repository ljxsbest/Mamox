...
public:
	...
	Reaction(Molecola              reac, Molecola              prod, double kinPar[3], std::string name_, std::string comment);
	Reaction(Molecola              reac, std::vector<Molecola> prod, double kinPar[3], std::string name_, std::string comment);
	Reaction(std::vector<Molecola> reac, std::vector<Molecola> prod, double kinPar[3], std::string name_, std::string comment);
	Reaction(std::vector<Molecola> reac, Molecola              prod, double kinPar[3], std::string name_, std::string comment);
