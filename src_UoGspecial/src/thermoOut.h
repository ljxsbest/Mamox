...
public:
	...
	std::string NASAOutputLumped(std::string name, std::vector<Molecola*> mols, std::vector<double> distr);
...
private:
	...
	ChemkinOut* chemOut;							// the pointer to the ChemkingOut object used by the main script
